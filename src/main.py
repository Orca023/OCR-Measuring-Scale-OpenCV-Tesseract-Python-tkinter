...
window_tkinter.default_inputTrain_path = default_inputTrain_path  # 'C:/Scale_OCR/inputTrain/'
window_tkinter.default_inputValidation_path = default_inputValidation_path  # 'C:/Scale_OCR/inputValidation/'
window_tkinter.default_inputTest_path = default_inputTest_path  # 'C:/Scale_OCR/inputTest/'
window_tkinter.input_dir = input_dir  # 'C:/Scale_OCR/inputTest/'
window_tkinter.default_outputTest_path = default_outputTest_path  # 'C:/Scale_OCR/outputTest/test.csv'
window_tkinter.output_dir = output_dir  # 'C:/Scale_OCR/outputTest/'
window_tkinter.iconbitmap_path = iconbitmap_path  # 'C:/Scale_OCR/Icon/iconbitmap.png'
...
optical_character_recognition.tesseract_cmd = tesseract_cmd  # 'C:/Scale_OCR/Tesseract-OCR/tesseract'
optical_character_recognition.tesseract_tessdata_dir = tesseract_tessdata_dir  # 'C:/Scale_OCR/Tesseract-OCR/tesseract/tessdata/chi_tra.traineddata'
optical_character_recognition.tesseract_user_words = tesseract_user_words  # 'C:/Scale_OCR/Tesseract-OCR/tesseract/tesswords/'
optical_character_recognition.tesseract_user_patterns = tesseract_user_patterns  # 'C:/Scale_OCR/Tesseract-OCR/'
optical_character_recognition.tesseract_timeout = tesseract_timeout  # float(0.0)
