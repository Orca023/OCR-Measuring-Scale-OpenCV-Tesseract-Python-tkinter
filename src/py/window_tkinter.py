...
if getattr(sys, 'frozen', False):
    iconbitmap_path = str(os.path.join(os.path.dirname(os.path.dirname(os.path.dirname(os.path.realpath(__file__)))), "Icon", "iconbitmap.png")).replace('\\', '/')
...
# 判斷是否爲打包（.exe）後的環境;
if getattr(sys, 'frozen', False):
    default_inputTrain_path = str(os.path.join(os.path.dirname(os.path.dirname(os.path.dirname(os.path.realpath(__file__)))), "inputTrain")).replace('\\', '/')
    ...
    default_inputValidation_path = str(os.path.join(os.path.dirname(os.path.dirname(os.path.dirname(os.path.realpath(__file__)))), "inputValidation")).replace('\\', '/')
    ...
    default_inputTest_path = str(os.path.join(os.path.dirname(os.path.dirname(os.path.dirname(os.path.realpath(__file__)))), "inputTest")).replace('\\', '/')
    ...
    default_outputTest_path = str(os.path.join(os.path.dirname(os.path.dirname(os.path.dirname(os.path.realpath(__file__)))), "outputTest", "test" + "." + str(is_storage_type))).replace('\\', '/')
...
input_dir = str(os.path.join(os.path.dirname(os.path.dirname(os.path.dirname(os.path.realpath(__file__)))), "inputTest")).replace('\\', '/')
# input_dir = str(os.path.normpath(os.path.join(os.path.normpath(str(os.getcwd())), "inputTest"))).replace('\\', '/')
output_dir = str(os.path.join(os.path.dirname(os.path.dirname(os.path.dirname(os.path.realpath(__file__)))), "outputTest")).replace('\\', '/')
